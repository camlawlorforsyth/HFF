...
def build_model(binNum=0, fit_metallicity=1, fit_redshift=1, infile=None,
    ...
    model_params['mass']['init'] = 1e6
    model_params['mass']['prior'] = LogUniform(mini=1e3, maxi=1e16)
    ...
    model_params['tage']['init'] = max_age/2
    model_params['tage']['prior'] = TopHat(mini=0.001, maxi=max_age)
    
    model_params['tau']['prior'] = LogUniform(mini=0.1, maxi=100)
