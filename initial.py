...
def a370_params() :
    ...
    bCGsegPath = 'sextractor/a370_model_segmap.fits.gz'
    ...
    models = ['models/a370_f275w_bcg_model.fits.gz',
              'models/a370_f336w_bcg_model.fits.gz',
              'models/a370_f435w_bcg_model.fits.gz',
              'models/a370_f475w_bcg_model.fits.gz',
              'models/a370_f606w_bcg_model.fits.gz',
              'models/a370_f625w_bcg_model.fits.gz',
              'models/a370_f814w_bcg_model.fits.gz',
              'models/a370_f105w_bcg_model.fits.gz',
              'models/a370_f110w_bcg_model.fits.gz',
              'models/a370_f125w_bcg_model.fits.gz',
              'models/a370_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell370_f160w_bcgs_model.fits.gz']
    ...
    return (cluster_redshift, sigma, delta_z_lo, delta_z_hi, redshift_type,
            first_path, second_path, filters, segPath, bCGsegPath, files,
            models, RMS)
...
def a1063_params() :
    ...
    bCGsegPath = 'sextractor/a1063_model_segmap.fits.gz'
    ...
    models = ['models/a1063_f225w_bcg_model.fits.gz', # user generated
              'models/a1063_f275w_bcg_model.fits.gz',
              'models/a1063_f336w_bcg_model.fits.gz',
              'models/a1063_f390w_bcg_model.fits.gz',
              'models/a1063_f435w_bcg_model.fits.gz',
              'models/a1063_f475w_bcg_model.fits.gz',
              'models/a1063_f606w_bcg_model.fits.gz',
              'models/a1063_f625w_bcg_model.fits.gz',
              'models/a1063_f775w_bcg_model.fits.gz',
              'models/a1063_f814w_bcg_model.fits.gz',
              'models/a1063_f850lp_bcg_model.fits.gz',
              'models/a1063_f105w_bcg_model.fits.gz',
              'models/a1063_f110w_bcg_model.fits.gz',
              'models/a1063_f125w_bcg_model.fits.gz',
              'models/a1063_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell1063_f160w_bcgs_model.fits.gz']
...
def a2744_params() :
    ...
    bCGsegPath = 'sextractor/a2744_model_segmap.fits.gz'
    ...
    models = ['models/a2744_f275w_bcg_model.fits.gz',
              'models/a2744_f336w_bcg_model.fits.gz',
              'models/a2744_f435w_bcg_model.fits.gz',
              'models/a2744_f606w_bcg_model.fits.gz',
              'models/a2744_f814w_bcg_model.fits.gz',
              'models/a2744_f105w_bcg_model.fits.gz',
              'models/a2744_f125w_bcg_model.fits.gz',
              'models/a2744_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell2744_f160w_bcgs_model.fits.gz']
...
def m416_params() :
    ...
    bCGsegPath = 'sextractor/m416_model_segmap.fits.gz'
    ...
    models = ['models/m416_f225w_bcg_model.fits.gz',
              'models/m416_f275w_bcg_model.fits.gz',
              'models/m416_f336w_bcg_model.fits.gz',
              'models/m416_f390w_bcg_model.fits.gz',
              'models/m416_f435w_bcg_model.fits.gz',
              'models/m416_f475w_bcg_model.fits.gz',
              'models/m416_f606w_bcg_model.fits.gz',
              'models/m416_f625w_bcg_model.fits.gz',
              'models/m416_f775w_bcg_model.fits.gz',
              'models/m416_f814w_bcg_model.fits.gz',
              'models/m416_f850lp_bcg_model.fits.gz',
              'models/m416_f105w_bcg_model.fits.gz',
              'models/m416_f110w_bcg_model.fits.gz',
              'models/m416_f125w_bcg_model.fits.gz',
              'models/m416_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs0416_f160w_bcgs_model.fits.gz']
...
def m717_params() :
    ...
    bCGsegPath = 'sextractor/m717_model_segmap.fits.gz'
    ...
    models = ['models/m717_f225w_bcg_model.fits.gz',
              'models/m717_f275w_bcg_model.fits.gz',
              'models/m717_f336w_bcg_model.fits.gz',
              'models/m717_f390w_bcg_model.fits.gz',
              'models/m717_f435w_bcg_model.fits.gz',
              'models/m717_f475w_bcg_model.fits.gz',
              'models/m717_f555w_bcg_model.fits.gz',
              'models/m717_f606w_bcg_model.fits.gz',
              'models/m717_f625w_bcg_model.fits.gz',
              'models/m717_f775w_bcg_model.fits.gz',
              'models/m717_f814w_bcg_model.fits.gz',
              'models/m717_f850lp_bcg_model.fits.gz',
              'models/m717_f105w_bcg_model.fits.gz',
              'models/m717_f110w_bcg_model.fits.gz',
              'models/m717_f125w_bcg_model.fits.gz',
              'models/m717_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs0717_f160w_bcgs_model.fits.gz']
...
def m1149_params() :
    ...
    bCGsegPath = 'sextractor/m1149_model_segmap.fits.gz'
    ...
    models = ['models/m1149_f225w_bcg_model.fits.gz', # user generated
              'models/m1149_f275w_bcg_model.fits.gz', # user generated
              'models/m1149_f336w_bcg_model.fits.gz',
              'models/m1149_f390w_bcg_model.fits.gz',
              'models/m1149_f435w_bcg_model.fits.gz',
              'models/m1149_f475w_bcg_model.fits.gz',
              'models/m1149_f555w_bcg_model.fits.gz',
              'models/m1149_f606w_bcg_model.fits.gz',
              'models/m1149_f625w_bcg_model.fits.gz',
              'models/m1149_f775w_bcg_model.fits.gz',
              'models/m1149_f814w_bcg_model.fits.gz',
              'models/m1149_f850lp_bcg_model.fits.gz',
              'models/m1149_f105w_bcg_model.fits.gz',
              'models/m1149_f110w_bcg_model.fits.gz',
              'models/m1149_f125w_bcg_model.fits.gz',
              'models/m1149_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs1149_f160w_bcgs_model.fits.gz']
...
def a370par_params() :
    ...
    bCGsegPath = 'sextractor/a370par_model_segmap.fits.gz'
    ...
    models = ['models/a370par_f435w_bcg_model.fits.gz',
              'models/a370par_f606w_bcg_model.fits.gz',
              'models/a370par_f814w_bcg_model.fits.gz',
              'models/a370par_f105w_bcg_model.fits.gz',
              'models/a370par_f125w_bcg_model.fits.gz',
              'models/a370par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell370par_f160w_bcgs_model.fits.gz']
    ...
    return (cluster_redshift, 0*u.km/u.s, delta_z_lo, delta_z_hi, redshift_type,
            first_path, second_path, filters, segPath, bCGsegPath, files,
            models, RMS)
...
def a1063par_params() :
    ...
    bCGsegPath = 'sextractor/a1063par_model_segmap.fits.gz'
    ...
    models = ['models/a1063par_f435w_bcg_model.fits.gz',
              'models/a1063par_f606w_bcg_model.fits.gz',
              'models/a1063par_f814w_bcg_model.fits.gz',
              'models/a1063par_f105w_bcg_model.fits.gz',
              'models/a1063par_f125w_bcg_model.fits.gz',
              'models/a1063par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell1063par_f160w_bcgs_model.fits.gz']
...
def a2744par_params() :
    ...
    bCGsegPath = 'sextractor/a2744par_model_segmap.fits.gz'
    ...
    models = ['models/a2744par_f435w_bcg_model.fits.gz',
              'models/a2744par_f606w_bcg_model.fits.gz',
              'models/a2744par_f814w_bcg_model.fits.gz',
              'models/a2744par_f105w_bcg_model.fits.gz',
              'models/a2744par_f125w_bcg_model.fits.gz',
              'models/a2744par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/abell2744par_f160w_bcgs_model.fits.gz']
...
def m416par_params() :
    ...
    bCGsegPath = 'sextractor/m416par_model_segmap.fits.gz'
    ...
    models = ['models/m416par_f435w_bcg_model.fits.gz',
              'models/m416par_f606w_bcg_model.fits.gz',
              'models/m416par_f775w_bcg_model.fits.gz',
              'models/m416par_f814w_bcg_model.fits.gz',
              'models/m416par_f850lp_bcg_model.fits.gz',
              'models/m416par_f105w_bcg_model.fits.gz',
              'models/m416par_f125w_bcg_model.fits.gz',
              'models/m416par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs0416par_f160w_bcgs_model.fits.gz']
...
def m717par_params() :
    ...
    bCGsegPath = 'sextractor/m717par_model_segmap.fits.gz'
    ...
    models = ['models/m717par_f435w_bcg_model.fits.gz',
              'models/m717par_f606w_bcg_model.fits.gz',
              'models/m717par_f814w_bcg_model.fits.gz',
              'models/m717par_f105w_bcg_model.fits.gz',
              'models/m717par_f125w_bcg_model.fits.gz',
              'models/m717par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs0717par_f160w_bcgs_model.fits.gz']
...
def m1149par_params() :
    ...
    bCGsegPath = 'sextractor/m1149par_model_segmap.fits.gz'
    ...
    models = ['models/m1149par_f435w_bcg_model.fits.gz',
              'models/m1149par_f606w_bcg_model.fits.gz',
              'models/m1149par_f814w_bcg_model.fits.gz',
              'models/m1149par_f105w_bcg_model.fits.gz',
              'models/m1149par_f125w_bcg_model.fits.gz',
              'models/m1149par_f140w_bcg_model.fits.gz',
              misc + 'images/bcgs_models/macs1149par_f160w_bcgs_model.fits.gz']
