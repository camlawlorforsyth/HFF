...
def build_model(binNum=0, fit_metallicity=0, fit_redshift=1, infile=None,
                add_neb=0, **extras) :
...
if __name__ == '__main__' :
    ...
    parser.add_argument('--fit_metallicity', type=int, default=0,
    ...
    outfile = '{}/h5/{}_ID_{}_bin_{}_shipley'.format(cluster, cluster, ID, binNum)
